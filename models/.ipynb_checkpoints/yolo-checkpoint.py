...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            Conv, AConv, ConvTranspose, CrossConv,
            Bottleneck, SPP, SPPF, DW, BottleneckCSP, nn.ConvTranspose2d, DWConvTranspose2d, SPPCSPC, ADown,
            RepNCSPELAN4, SPPELAN,CBAM, BoTNet,CARAFE, VoVGSCSP,ContextAggregation, CrissCrossAttention, AKConv,DSConv,DySnakeConv, C2f_DySnakeConv, ODConv,EMA_attention, Involution, C2f_LSKA_Attention,LSKA_Attention,LSKA}:
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, SPPCSPC,C2f_LSKA_Attention}:
